...
parser.add_argument('--lines', nargs='*', type=int, default=[500], help='list of integers representing the number of lines to try out. Used together with --columns. For example "--lines 20 --columns 4" will try (20, 4)')
...
for lines in args.lines:
	for columns in args.columns:
		...
		ts = query.timeseries(datasource = 'master', 
				...
				aggregations = { "cdrezult": {"type": "cd", "timeField": "__time", "columns": dims}})
