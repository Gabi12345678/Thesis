...
parser = argparse.ArgumentParser(description = 'Script to run Recovery of missing values in Druid')
...
for lines in args.lines:
	for columns in args.columns:
		...
		ts = query.timeseries(datasource = 'master', 
				...
				aggregations = { "recovresult": {"type": "recov", "timeField": "__time", "columns": dims}})
		...
		print("Recovery of missing value time:", final_time_udf - initial_time_udf)
		print("*" * 100)
