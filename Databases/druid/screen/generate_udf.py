...
parser = argparse.ArgumentParser(description = 'Script to run Screen in eXtremeDB')
...
for lines in args.lines:
	for columns in args.columns:
		...
		ts = query.timeseries(datasource = 'master', 
				...
				aggregations = { "screenresult": {"type": "screen", "timeField": "__time", "columns": dims}})
		...
		print("Screen time:", final_time_udf - initial_time_udf)
		print("*" * 100)
