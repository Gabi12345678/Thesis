...
parser = argparse.ArgumentParser(description = 'Script to run Znormalization in Druid')
...
for lines in args.lines:
	for columns in args.columns:
		...
		ts = query.timeseries(datasource = 'master', 
				...
				aggregations = { "norm": {"type": "znormalization", "timeField": "__time", "columns": dims}})
		...
		print("Z-score time:", final_time_udf - initial_time_udf)
		print("*" * 100)
