...
create function import_data() RETURNS string in 'python' as '
	...
	f = open("/home/gabi/Thesis-master/Datasets/sport.txt.csv", "r")
...
SELECT 	MAX(current_time) - MIN(current_time) AS insert_time, 
	...
	10.0 * 2.0 / (MAX(current_time) - MIN(current_time)) as Throughput_values_per_second 
FROM metrics_insert;

INSERT INTO metrics_udf VALUES(current_time());
INSERT INTO result SELECT t, sqrt((a[0] - b[0])*(a[0] - b[0]) + (a[1] - b[1])*(a[1] - b[1])) FROM datapoints;
INSERT INTO metrics_udf VALUES(current_time());
