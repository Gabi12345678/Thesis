...
char sample_descr[] = {
  "Sample 'disk_crc' opens a database and protects its pages by CRC.\n"
};
const char * db_name = "disk_crc";
...
int main(int argc, char* argv[])
{
  ...
  db_params.mode_mask         |= MCO_DB_USE_CRC_CHECK;/* Set CRC over database file */
