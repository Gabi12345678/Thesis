...
char sample_descr[] = {
  "Sample 'binary' demonstrates eXtremeDB patricia tree match functions\n"
  "using a binary key (a vector of bits).\n"
};
const char * db_name = "binarydb";
...
int main(int argc, char* argv[])
{
  ...
  rc = sample_open_database( db_name, binarydb_get_dictionary(), DATABASE_SIZE, CACHE_SIZE, 
