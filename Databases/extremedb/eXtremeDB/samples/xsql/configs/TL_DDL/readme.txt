...
This configuration demonstrates a DDL capable in-memory database with
transaction logging (TL) enabled. The log is written to a file while
previous state of database is stored in a DB snapshot file.
