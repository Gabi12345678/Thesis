...
SELECT DISTINCT S.sname FROM S WHERE NOT EXISTS (SELECT * FROM SP WHERE SP.pid = S.sid AND SP.pid = 'P2');
...
SELECT DISTINCT S.city AS SCITY, J.city AS JCITY FROM S, J 
