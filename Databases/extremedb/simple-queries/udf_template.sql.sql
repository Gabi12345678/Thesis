...
SELECT  MAX(current_time) - MIN(current_time) AS insert_time, 
	10.0 / (MAX(current_time) - MIN(current_time)) as Throughput_values_per_second
FROM metrics_insert;
...
INSERT INTO result_interval SELECT t, d FROM datapoints WHERE t > cast('2014-01-01' as timestamp) AND t < cast('2019-01-01' as timestamp);
INSERT INTO metrics_interval VALUES(current_time());
