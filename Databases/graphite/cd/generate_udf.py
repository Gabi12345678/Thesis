...
parser = argparse.ArgumentParser(description = 'Script to run CD in Graphite')
...
for lines in args.lines:
	for columns in args.columns:
		...
		params = {
			...
			'until': t2 + 20,
			'format': 'csv',
			'target': 'cd(master.' + args.format + '.dim*)',
		}
		...
		print("+" * 100)
		print("CentroidDecomposition time: ", final_time - initial_time)
		print("+" * 100)
