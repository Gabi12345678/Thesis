...
parser = argparse.ArgumentParser(description = 'Script to run Screen in Graphite')
...
for lines in args.lines:
	for columns in args.columns:
		...
		params = {
			...
			'until': t2 + 20,
			'format': 'csv',
			'target': 'screen(master.' + args.format + '.dim*)',
		}
		...
		print("+" * 100)
		print("Screen time: ", final_time - initial_time)
		print("+" * 100)
