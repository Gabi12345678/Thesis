...
args.screen_handler_template_path = os.path.abspath('template_screen_handler.py')
...
generate_from_template(template_path = args.kapacitor_config_template_path, file_path = args.kapacitor_config_path,
                        changes = [("<handler_path>", args.screen_handler_path), ("<home_path>", args.home_path)])
generate_from_template(template_path = args.screen_handler_template_path, file_path = args.screen_handler_path,
...
subprocess.run(["rm", args.screen_handler_path])
