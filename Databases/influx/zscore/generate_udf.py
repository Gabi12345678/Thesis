...
# Arguments
parser = argparse.ArgumentParser(description = 'Script to run Z-Score in Influx')
...
args.kmeans_handler_template_path = os.path.abspath('template_zscore_handler.py')
args.kmeans_handler_path = os.path.abspath('zscore_handler.py')
...
for line in args.lines:
	for column in args.columns:
		...
		client = InfluxDBClient(database = 'master', timeout = 20)
