...
public class CDJavaAggregator implements Aggregator {
	public static final Logger logger = (Logger) LoggerFactory.getLogger(CDJavaAggregator.class);
	...
	@Inject
	public CDJavaAggregator(DoubleDataPointFactory dataPointFactory) {
