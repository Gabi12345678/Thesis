...
public class HotSaxJavaAggregator implements Aggregator {
	public static final Logger logger = (Logger) LoggerFactory.getLogger(HotSaxJavaAggregator.class);
	...
	@Inject
	public HotSaxJavaAggregator(DoubleDataPointFactory dataPointFactory) {
