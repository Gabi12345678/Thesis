...
public class KMeansJavaAggregator implements Aggregator {
	public static final Logger logger = (Logger) LoggerFactory.getLogger(KMeansJavaAggregator.class);
	...
	@Inject
	public KMeansJavaAggregator(DoubleDataPointFactory dataPointFactory) {
