...
public class RecovJavaAggregator implements Aggregator {
	public static final Logger logger = (Logger) LoggerFactory.getLogger(RecovJavaAggregator.class);
	...
	@Inject
	public RecovJavaAggregator(DoubleDataPointFactory dataPointFactory) {
	...
	public DataPointGroup aggregate(DataPointGroup dataPointGroup) {
			...
			RealMatrix result = Recovdb.recovery(input, columns - 1, 0.2, 1);
