...
CREATE TABLE clusters (time TIMESTAMP, <column_types>);
...
CREATE OR REPLACE FUNCTION cluster_alg(time TIMESTAMP, <column_types>) RETURNS TABLE(time TIMESTAMP, <column_types>)
LANGUAGE PYTHON
{
        import sys
        import numpy as np
