...
parser.add_argument('--lines', nargs = '?', type = int, help = 'Number of lines to test', default = 100)
...
toRun = ['python3', 'generate_udf.py', '--file', str(args.dataset), '--lines', str(args.lines)]
